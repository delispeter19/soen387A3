...
<%@ page import="com.a3.Factories.MapperFactory"%>
<%@ page import="com.a3.Interfaces.InheritanceMapper"%>
<%@ page import="com.a3.Mappers.TokenMapper"%>
<%@ page import="com.a3.Factories.PersonFactory"%>
<%@ page import="com.a3.Models.Person"%>
                ...
                if (tokenMapper.find(token)){
                    ...
                    if (mapper != null && person != null){
                        if(mapper.find(person)){
                            ...
                            payload.put("user", mapper.getJsonFrom(person));
